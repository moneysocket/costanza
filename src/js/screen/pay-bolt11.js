...
class PayBolt11Screen {
    ...
    drawOkButton(div, ok_func) {
        var b = D.button(div, ok_func, "main-button");
    ...
    drawCancelButton(div, cancel_func) {
        var b = D.button(div, cancel_func, "main-button");
        var flex = D.emptyDiv(b, "flex items-center justify-around");
        var icon_span = D.emptySpan(flex, "px-2");
        var back = I.xcircle2x(icon_span);
        var text = D.textSpan(flex, "Cancel");
    }
    ...
    drawBolt11Panel(div, err_str) {
        ...
        this.drawCancelButton(button_flex, this.oncancelclick);
    }
    ...
    drawError(bolt11) {
        ...
        this.drawBolt11Panel(flex_mid, err_str);
    }
}

exports.PayBolt11Screen = PayBolt11Screen;
